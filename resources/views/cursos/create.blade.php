...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center mb-4">
        ...
        <div>
            <h1 class="h3 mb-0">Crear Nuevo Curso</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('modalidad') is-invalid @enderror" 
                                    ...
                                    <option value="hibrido" {{ old('modalidad') == 'hibrido' ? 'selected' : '' }}>
                                        <i class="fas fa-laptop"></i> Híbrido
                                    </option>
                                </select>
                                @error('modalidad')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-12 mb-3" id="aula_virtual_container" style="display: none;">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled mb-0">
                                    <li class="mb-2">
                                        ...
                                        El curso se creará con estado "Activo"
                                    </li>
                                    <li class="mb-2">
                                        <i class="fas fa-check-circle text-success me-2"></i>
                                        Se validará la disponibilidad del docente
                                    </li>
                                    <li class="mb-2">
                                        <i class="fas fa-check-circle text-success me-2"></i>
                                        Se controlará el límite de cursos por docente
                                    </li>
                                    <li>
                                        <i class="fas fa-check-circle text-success me-2"></i>
                                        Los alumnos podrán inscribirse inmediatamente
                                    </li>
                                </ul>
                            </div>
                        </div>

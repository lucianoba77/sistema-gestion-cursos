...
class CursoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'docente_id' => 'required|exists:docentes,id|docente_activo|docente_max_cursos',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'docente_id.docente_max_cursos' => 'El docente ya tiene el máximo de cursos activos permitidos (3).',
        ];
    }
    ...
    public function withValidator($validator)
    {
        ...
        $validator->addExtension('docente_max_cursos', function ($attribute, $value, $parameters, $validator) {
            $docente = \App\Models\Docente::find($value);
            return $docente && $docente->puedeAsignarCursos();
        });
    }
}
